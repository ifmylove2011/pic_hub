...
public class ImageLoader2 {
	...
	static class MainHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case MESSAGE_POST_RESULT:
				...
				LoaderResult result = (LoaderResult) msg.obj;
				ImageView view = result.imageView;
				String uri = (String) view.getTag(TAG_KEY_URI);
	...
	public void bindBitmap(final String uri, final ImageView iv, boolean isSquare) {
		mIsSquare = isSquare;
		bindBitmap(uri, iv, ViewUtils.getDefaultSize() / 4, ViewUtils.getDefaultSize() / 4, isSquare);
	}
	...
	public void bindBitmap(final String uri, final ImageView imageView, final int reqWidth, final int reqHeight,
		...
		Runnable loadBitmapTask = new Runnable() {
			...
			public void run() {
				...
				LoaderResult result = new LoaderResult(uri, bitmap, imageView);
